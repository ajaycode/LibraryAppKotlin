...
class LibraryAppKotlinApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes LibraryAppKotlin.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<LibraryAppKotlinApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(LibraryAppKotlinApp::class.java)
