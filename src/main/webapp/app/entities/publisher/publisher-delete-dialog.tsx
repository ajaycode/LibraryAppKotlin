...
export const PublisherDeleteDialog = (props: IPublisherDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="libraryAppKotlinApp.publisher.delete.question">
        <Translate contentKey="libraryAppKotlinApp.publisher.delete.question" interpolate={{ id: publisherEntity.id }}>
