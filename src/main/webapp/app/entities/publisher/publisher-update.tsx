  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="libraryAppKotlinApp.publisher.home.createOrEditLabel" data-cy="PublisherCreateUpdateHeading">
            <Translate contentKey="libraryAppKotlinApp.publisher.home.createOrEditLabel">Create or edit a Publisher</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
