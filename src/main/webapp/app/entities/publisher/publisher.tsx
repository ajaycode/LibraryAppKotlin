...
export const Publisher = (props: IPublisherProps) => {
  ...
  const { publisherList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="publisher-heading" data-cy="PublisherHeading">
        <Translate contentKey="libraryAppKotlinApp.publisher.home.title">Publishers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="libraryAppKotlinApp.publisher.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="libraryAppKotlinApp.publisher.home.createLabel">Create new Publisher</Translate>
          </Link>
        </div>
      </h2>
        ...
        {publisherList && publisherList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="libraryAppKotlinApp.publisher.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="libraryAppKotlinApp.publisher.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`${match.url}/${publisher.id}`} color="info" size="sm" data-cy="entityDetailsButton">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="libraryAppKotlinApp.publisher.home.notFound">No Publishers found</Translate>
            </div>
          )
        )}
      </div>
