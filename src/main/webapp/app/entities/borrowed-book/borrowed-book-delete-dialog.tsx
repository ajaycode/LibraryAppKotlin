...
export const BorrowedBookDeleteDialog = (props: IBorrowedBookDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="libraryAppKotlinApp.borrowedBook.delete.question">
        <Translate contentKey="libraryAppKotlinApp.borrowedBook.delete.question" interpolate={{ id: borrowedBookEntity.id }}>
