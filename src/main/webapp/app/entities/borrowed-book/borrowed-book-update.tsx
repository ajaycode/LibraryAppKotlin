  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="libraryAppKotlinApp.borrowedBook.home.createOrEditLabel" data-cy="BorrowedBookCreateUpdateHeading">
            <Translate contentKey="libraryAppKotlinApp.borrowedBook.home.createOrEditLabel">Create or edit a BorrowedBook</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : borrowedBookEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="borrowed-book-borrowDate" data-cy="borrowDate" type="date" className="form-control" name="borrowDate" />
              </AvGroup>
              <AvGroup>
                <Label for="borrowed-book-book">
                  <Translate contentKey="libraryAppKotlinApp.borrowedBook.book">Book</Translate>
                </Label>
                <AvInput id="borrowed-book-book" data-cy="book" type="select" className="form-control" name="bookId">
                  <option value="" key="0" />
                  {books
              ...
              <AvGroup>
                <Label for="borrowed-book-client">
                  <Translate contentKey="libraryAppKotlinApp.borrowedBook.client">Client</Translate>
                </Label>
                <AvInput id="borrowed-book-client" data-cy="client" type="select" className="form-control" name="clientId">
                  <option value="" key="0" />
                  {clients
