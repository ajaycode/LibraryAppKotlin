...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_BORROWEDBOOK: 'borrowedBook/PARTIAL_UPDATE_BORROWEDBOOK',
...
export default (state: BorrowedBookState = initialState, action): BorrowedBookState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_BORROWEDBOOK):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_BORROWEDBOOK):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_BORROWEDBOOK):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IBorrowedBook> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_BORROWEDBOOK,
